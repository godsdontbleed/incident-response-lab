# **Detecting & Removing Malicious Cron Jobs**

---

## 🎯 **Objective:**  
Investigate and respond to a malicious cron job implanted for persistence on a Linux system. This lab demonstrates how to detect unauthorized scheduled tasks, analyze the associated payload, remove the threat, and implement preventive measures following the incident response lifecycle.
---
