# **Detecting and Responding to Script-Based Threats**

---

## 🎯 **Objective:**  
The objective of this lab is to simulate and investigate a suspicious bash script execution on a Linux system. The lab demonstrates how to detect malicious processes, analyze system activity, contain and remove the threat, and implement preventive measures as part of the incident response lifecycle.
---
